...
with streamlit.sidebar:
    ...
    button_new_dialogue = streamlit.button("新建对话", icon="😽",width="stretch")
    button_save = streamlit.button("保存对话", icon="💾",width="stretch")
...
#    #非流式对话
#    content_assistant = response.choices[0].message.content
#    streamlit.chat_message("assistant").write(content_assistant)   #显示网页ai对话
#    print("assistant content:",content_assistant) #输出ai输入
#    #存储对话
#    streamlit.session_state.content_store.append({"role": "assistant", "content": content_assistant})
#    print(streamlit.session_state.content_store)
#print(*streamlit.session_state.content_store)
